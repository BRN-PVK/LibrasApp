import {
  ...
  const CarPessoais = (image, txt, navigation) => {
    ...
    return (
      <ScrollView style={styles.container}>
        <TopBar title={"Características Pessoais"} />
  
        <View style={styles.body}>
          <Text style={styles.nothTxtl}>Assista a vídeo-aula a seguir e aprenda os sinais de cada característica pessoal em Libras.</Text>
