import {
  ...
  const CarPsicologicas = (image, txt, navigation) => {
    ...
    return (
      <ScrollView style={styles.container}>
        <TopBar title={"Características Psicológicas"} />
  
        <View style={styles.body}>
          <Text style={styles.nothTxtl}>Assista a vídeo-aula a seguir e aprenda os sinais de cada característica psicológica em Libras.</Text>
  ...
  export default CarPsicologicas;
